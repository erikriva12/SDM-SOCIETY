            ...
            <div class="authentication-inner py-6 mx-4">
                ...
                <div class="card p-sm-7 p-2">
                    ...
                    <div class="card-body mt-1">
                        ...
                        <p class="mb-5">Masuk dengan email dan password anda</p>
                        <form id="formLogin" class="mb-5" action="{{ route('actionLogin') }}" method="POST">
    ...
    <script>
        $("#formLogin").submit(function () {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    Swal.fire({
                        html: `<h4>Mohon Tunggu Sebentar</h4>`,
                        didOpen: () => {
                            Swal.showLoading();
                        },
                    });
                ...
                success: function (response) {
                    ...
                    // Simpan token ke localStorage (atau cookie, sesuai kebutuhanmu)
                    localStorage.setItem("jwt_token", response.access_token);

                    Swal.fire({
                        icon: "success",
                        title: "Berhasil Login",
                        text: "Anda akan diarahkan ke dashboard segera.",
                        timer: 2000,
